...
export const INITIAL_PRODUCTS: Product[] = [
  // 1. Drip client panel (ANDROID NON ROOT PANEL)
  {
    id: 101,
    name: '1 Day',
    panel_name: 'Drip client panel',
    ...
    provider_product_id: 'PID_DRIP_NONROOT',
  ...
  },
  {
    ...
    category: 'ANDROID NON ROOT PANEL',
    price_inr: 600.0,
    reseller_price: 400.0,
    reseller_price_inr: 400.0,
    validity: '30 Days',
    device_limit: '1 Device HWID',
    apk_link: 'https://t.me/KalamFFPanelAPKs',
    is_active: 1,
  ...
  // 3. KALAM ROOT ULTRA BYPASS PANEL
  {
    id: 301,
    name: '1 Day',
    ...
    maintenance_note: '',
    delivery_mode: 'api_provider',
    provider_product_id: 'PID_FF_ROOT_V1',
    provider_duration: '1 Day',
  ...
  },
  {
    ...
    category: 'ANDROID ROOT PANEL',
    price_inr: 350.0,
    reseller_price: 250.0,
    reseller_price_inr: 250.0,
    validity: '7 Days',
    device_limit: '1 Device HWID',
    apk_link: 'https://t.me/KalamFFPanelAPKs',
    is_active: 1,
  ...
  // 4. KALAM PC EMULATOR INJECTOR
  {
    ...
    maintenance_note: '',
    delivery_mode: 'api_provider',
    provider_product_id: 'PID_FF_PC_V1',
    provider_duration: '1 Day',
    requires_android_id: false
  },
  {

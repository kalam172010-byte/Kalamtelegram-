...
export const ResellerApiManager: React.FC = () => {
  ...
  if (!activeBot) {
    return (
      <div className="w-full h-full overflow-y-auto bg-slate-950 p-6 flex flex-col items-center justify-center text-center space-y-4">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-sm font-bold transition cursor-pointer"
        >
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900/80 border border-slate-800 rounded-2xl p-4 md:p-6 backdrop-blur">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-500 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-purple-500/20">
          ...
          <div className="flex items-center gap-2 bg-slate-950 border border-slate-800 p-2 rounded-xl">
            ...
            <select
              ...
              className="bg-slate-900 border border-slate-700 text-xs font-bold text-white rounded-lg px-2.5 py-1 focus:outline-none focus:border-purple-500"
            >
              {myBots.map((b) => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-4 flex items-center justify-between">
            <div>
              <div className="text-xs text-slate-400">Auto Key Fallback</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-slate-900/80 border border-slate-800 rounded-2xl p-5 md:p-6 space-y-5">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              ...
              {saveSuccess && (
                <span className="text-xs bg-purple-500/20 text-purple-300 font-bold px-2.5 py-1 rounded-md border border-purple-500/30 flex items-center gap-1 animate-pulse">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-xs font-bold shadow-lg shadow-purple-500/20 transition cursor-pointer"
                >
                  Save Reseller API
                </button>
          ...
          <div className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3 py-1.5 text-xs font-mono text-cyan-300"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs shadow-md transition flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
                >
                ...
                {generatedKey && (
                  <div className="bg-purple-950/50 border border-purple-800 rounded-xl p-3 space-y-1.5">
                    <div className="text-[10px] text-purple-300 font-bold uppercase">Delivered License Key:</div>
                    <div className="font-mono text-xs text-emerald-400 font-bold break-all bg-slate-950 p-2 rounded border border-slate-800 select-all">
                      {generatedKey}
                    </div>
                  </div>
                )}
                ...
                {genError && (
                  <div className="text-xs text-pink-400 bg-pink-950/40 p-2.5 rounded-lg border border-pink-800/80">
                    ⚠ {genError}
                  </div>
                )}
              </div>
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 text-xs text-slate-400 leading-relaxed space-y-2">

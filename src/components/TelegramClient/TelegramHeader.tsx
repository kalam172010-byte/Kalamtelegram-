...
import { RefreshCw, Smartphone, Monitor, Bot as BotIcon, Maximize2 } from 'lucide-react';
    ...
    return (
      <div className="bg-slate-900/98 backdrop-blur border-b border-slate-800 px-4 md:px-6 py-3 flex items-center justify-between gap-3 shrink-0 select-none">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-white">No Telegram Bot Selected</h1>
      ...
      <div className="flex items-center gap-3 min-w-0">
        <div className="relative shrink-0">
          <div
            ...
            className="w-11 h-11 rounded-2xl flex items-center justify-center text-white font-black text-lg shadow-lg ring-2 ring-cyan-500/20"
          >
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <h1 className="text-base md:text-lg font-bold text-white truncate flex items-center gap-1.5">
              {activeBot.name}
          ...
          <p className="text-xs md:text-sm text-slate-400 flex items-center gap-1.5 truncate">
